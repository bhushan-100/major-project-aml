...
def create_parser():
    ...
    #Model parameters
    parser.add_argument("--batch_size", default=512, type=int, help="Select the batch size for GNN training")
    ...
    parser.add_argument("--unique_name", default="default_name", type=str, help="Unique name under which the model will be stored.", required=True)
    ...
    parser.add_argument("--load_ckpt", action='store_true', help='Load a model to resume training')
